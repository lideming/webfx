(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@yuuza/i18n')) :
    typeof define === 'function' && define.amd ? define(['exports', '@yuuza/i18n'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.webfx = {}, global.i18n));
})(this, (function (exports, i18n) { 'use strict';
    ...
    class Dialog extends View {
        constructor() {
            ...
            this.btnClose = new TextBtn({ text: i18n.I `Close`, right: true });
            this.title = 'Dialog';
    ...
    class MessageBox extends Dialog {
        ...
        addResultBtns(results) {
            for (const r of results) {
                this.addBtnWithResult(new TextBtn({ text: i18n.i18n.get('msgbox_' + r), right: true }), r);
            }
            return this;
        }
        setTitle(title) {
    ...
    class LoadingIndicator extends View {
        ...
        reset() {
            this.state = 'running';
            this.content = i18n.I `Loading`;
            this.onclick = null;
        }
        error(err, retry) {
            this.state = 'error';
            this.content = i18n.I `Oh no! Something just goes wrong:` + '\r\n' + err;
            if (retry) {
                this.content += '\r\n' + i18n.I `[Click here to retry]`;
            }
            this.onclick = retry;
        }
        action(func) {
